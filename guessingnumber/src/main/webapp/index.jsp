...
<title>Game Guessing Number</title>
...
<c:set var="playerState" value="${GameMethod.register_state}" scope="request" />
<script>
...
<body>
	<div class="vertical-center">
		<div class="container">
			<h1>Game Guessing Number</h1>
			<p>
				(<span>Nhập tên người chơi</span>)
			</p>
			...
			<div class="board">
				<h5>Bảng xếp hạng người chơi</h5>
				<div class="scrollbar">
